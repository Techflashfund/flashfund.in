        ...
        {[...Array(6)].map((_, i) => (
          <motion.div
            ...
            className={`absolute rounded-full bg-gradient-to-r ${
              i % 2 === 0 
                ? 'from-purple-400/5 to-indigo-600/5' 
                : 'from-indigo-500/5 to-violet-700/5'
            }`}
            initial={{
              scale: 0.8,
              opacity: 0.05,
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              className="relative overflow-hidden group bg-gradient-to-r from-purple-500 via-indigo-600 to-purple-500 hover:from-purple-600 hover:via-indigo-700 hover:to-purple-600 text-white shadow-lg shadow-indigo-500/25"
              size="lg"
            >
              <motion.span 
