...
const SupplyChainFinance = () => {
  const features = [
    {
      icon: Link2,
      title: "End-to-End Financing",
      description: "Comprehensive financial solutions covering your entire supply chain network"
    },
    {
      icon: Shield,
      title: "Risk Mitigation",
      description: "Secure transactions with comprehensive risk assessment and management"
    },
    {
      icon: Users,
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium">Supply Chain Solution</span>
          </motion.div>
          ...
          <span className='text-gray-400 font-semibold'>Registered on <span className='text-purple-700 font-bold'>ONDC</span> Protocol</span>
          
          <motion.p
            variants={itemVariants}
            className="text-xl text-gray-600 max-w-2xl mx-auto m-8"
          >
            Optimize your supply chain with innovative financing solutions.
            Unlock working capital and strengthen supplier relationships.
          </motion.p>
